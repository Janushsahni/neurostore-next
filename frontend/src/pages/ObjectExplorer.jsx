                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-slate-950/50 border border-slate-800 rounded-3xl p-8 relative overflow-hidden backdrop-blur-sm group hover:border-emerald-500/30 transition-all">
                            ...
                            <div className="space-y-6 relative z-10">
                                <div className="flex items-center justify-between group">
                                    <span className="text-slate-400 text-sm">Object Status</span>
                                    <span className="text-white font-bold text-lg bg-slate-900 px-4 py-1 rounded-xl">Distributed</span>
                                </div>
                                <div className="flex items-center justify-between group">
                        ...
                        <div className="bg-[#0b1120] border border-blue-500/20 rounded-3xl p-8 shadow-[0_15px_50px_rgba(0,0,0,0.5)]">
                            ...
                            <p className="text-xs text-slate-400 mb-6 leading-relaxed">
                                ...
                                Each shard is verified for residency and integrity by the network Sentinel.
                            </p>
                            <div className="pt-6 border-t border-slate-800">
                                <div className="text-[10px] text-slate-500 uppercase tracking-widest font-bold mb-2">Technical Identifier</div>
